...
public class ApgTerm<L, E> {
	...
	private ApgTerm(E e, Object v, Map<String, ApgTerm<L, E>> m, String f, ApgTerm<L, E> a, Var var, String proj,
			Map<String, Pair<Var, ApgTerm<L, E>>> c, L deref, String prim, ApgTy<L> cases_t, List<ApgTerm<L, E>> args,
			String head) {
		this.e = e;
		this.value = v;
		this.fields = m;
	...
	private static synchronized <L, E> ApgTerm<L, E> mkApgTerm(E e, Object v, Map<String, ApgTerm<L, E>> m, String f,
			ApgTerm<L, E> a, Var var, String proj, Map<String, Pair<Var, ApgTerm<L, E>>> c, L d, String prim,
	...
	public static synchronized <L, E> ApgTerm<L, E> ApgTermCase(ApgTerm<L, E> arg,
			Map<String, Pair<Var, ApgTerm<L, E>>> str, ApgTy<L> cases_t) {
