...
//	MPL,
	...
	public CodeEditor createEditor(String title, int id, String content) {
		switch (this) {
		case CQL: return new AqlCodeEditor(title, id, content);
		case CQL_ALT: return new AqlCodeEditor(title, id, content);
		case EASIK: 
		case SKETCH: 
		default:
			throw new RuntimeException("Anomaly - please report");
	...
	public List<Example> getExamples() {
		switch (this) {
		case CQL: return Examples.getExamples(Language.CQL);
		case CQL_ALT: return Examples.getExamples(Language.CQL_ALT);
