...
public class TypeSide<Ty, Sym> implements Semantics {
	...
	public synchronized Map<Ty, Set<Term<Ty, Void, Sym, Void, Void, Void, Void>>> makeModel(Map<Var, Chc<Ty, Void>> ctx) {
	...
	private <En,Fk,Att,Gen,Sk> Ty type(Map<Var, Ty> ctx, Term<Ty, En, Sym, Fk, Att, Gen, Sk> term) {
		...
		Chc<Ty, En> t = term.type(ctx, Collections.emptyMap(), tys, syms, js.java_tys, Collections.emptySet(), Collections.emptyMap(), Collections.emptyMap(), Collections.emptyMap(), Collections.emptyMap());
		if (!t.left) {
	...
	private static <Ty, Sym> Collage<Ty, Void, Sym, Void, Void, Void, Void> col(Set<Ty> tys, Map<Sym, Pair<List<Ty>, Ty>> syms, Set<Triple<Map<Var, Ty>, Term<Ty, Void, Sym, Void, Void, Void, Void>, Term<Ty, Void, Sym, Void, Void, Void, Void>>> eqs, Map<Ty, String> java_tys, Map<Ty, String> java_parsers, Map<Sym, String> java_fns) {
	...
	public TypeSide(Set<Ty> tys, Map<Sym, Pair<List<Ty>, Ty>> syms, Set<Triple<Map<Var, Ty>, Term<Ty, Void, Sym, Void, Void, Void, Void>, Term<Ty, Void, Sym, Void, Void, Void, Void>>> eqs, Map<Ty, String> java_tys_string, Map<Ty, String> java_parser_string, Map<Sym, String> java_fns_string, AqlOptions strategy) {
	...
	public TypeSide(Set<Ty> tys, Map<Sym, Pair<List<Ty>, Ty>> syms, Set<Triple<Map<Var, Ty>, Term<Ty, Void, Sym, Void, Void, Void, Void>, Term<Ty, Void, Sym, Void, Void, Void, Void>>> eqs, AqlJs<Ty,Sym> js, DP<Ty, Void, Sym, Void, Void, Void, Void> semantics, AqlOptions strategy) {
	...
	private String toString(Triple<Map<Var, Ty>, Term<Ty, Void, Sym, Void, Void, Void, Void>, Term<Ty, Void, Sym, Void, Void, Void, Void>> eq) {
	...
	public static <X,Y> TypeSide<X,Y> initial(AqlOptions ops) {
		return new TypeSide<>(Collections.emptySet(), Collections.emptyMap(), Collections.emptySet(), new AqlJs<>(Collections.emptyMap(), Collections.emptyMap(), Collections.emptyMap(), Collections.emptyMap()), DP.initial(), ops);
	}
	...
	public synchronized DP<Ty, Void, Sym, Void, Void, Void, Void> semantics() {
		...
		semantics = AqlProver.createTypeSide(strat, collage(), js); //(tys, syms, eqs, java_tys_string, java_parser_string, java_fns_string), js);		
