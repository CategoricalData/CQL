...
public class CoEvalEvalCoUnitTransform<Ty, En1, Sym, Fk1, Att1, Gen, Sk, En2, Fk2, Att2, X, Y> extends
		Transform<Ty, En1, Sym, Fk1, Att1, Triple<Var, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, En2>, Chc<Triple<Var, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, En2>, Y>, Gen, Sk, Integer, Chc<Chc<Triple<Var, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, En2>, Y>, Pair<Integer, Att1>>, X, Y> {
	...
	private final CoEvalInstance<Ty, En1, Sym, Fk1, Att1, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, Y, En2, Fk2, Att2, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, Y> K; // TODO
																																																		// aql
																																																		// recomputes
	private final BiFunction<Triple<Var, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, En2>, En1, Term<Void, En1, Void, Fk1, Void, Gen, Void>> gens; // =
																																									// new
																																									// THashMap<>(
	private final BiFunction<Chc<Triple<Var, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, En2>, Y>, Ty, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>> sks; // =
																																									// new
																																									// THashMap<>(
	...
	@Override
	public BiFunction<Triple<Var, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, En2>, En1, Term<Void, En1, Void, Fk1, Void, Gen, Void>> gens() {
		return gens;
	}

	@Override
	public BiFunction<Chc<Triple<Var, Row<En2, Chc<X, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>>, Chc<En1,Ty>>, En2>, Y>, Ty, Term<Ty, En1, Sym, Fk1, Att1, Gen, Sk>> sks() {
		return sks;
	}
