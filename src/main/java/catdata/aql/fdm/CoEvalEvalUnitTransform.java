...
public class CoEvalEvalUnitTransform<Ty, En1, Sym, Fk1, Att1, Gen, Sk, En2, Fk2, Att2, X, Y> extends
		Transform<Ty, En2, Sym, Fk2, Att2, Gen, Sk, Row<En2, Chc<Integer, Term<Ty, En1, Sym, Fk1, Att1, Triple<Var, X, En2>, Chc<Triple<Var, X, En2>, Y>>>, Chc<En1,Ty>>, Chc<Chc<Triple<Var, X, En2>, Y>, Pair<Integer, Att1>>, X, Y, Row<En2, Chc<Integer, Term<Ty, En1, Sym, Fk1, Att1, Triple<Var, X, En2>, Chc<Triple<Var, X, En2>, Y>>>, Chc<En1,Ty>>, Chc<Chc<Triple<Var, X, En2>, Y>, Pair<Integer, Att1>>> {
	// TODO aql recomputes
	...
	private final BiFunction<Gen, En2, Term<Void, En2, Void, Fk2, Void, Row<En2, Chc<Integer, Term<Ty, En1, Sym, Fk1, Att1, Triple<Var, X, En2>, Chc<Triple<Var, X, En2>, Y>>>, Chc<En1,Ty>>, Void>> gens; 
	private final BiFunction<Sk, Ty, Term<Ty, En2, Sym, Fk2, Att2, Row<En2, Chc<Integer, Term<Ty, En1, Sym, Fk1, Att1, Triple<Var, X, En2>, Chc<Triple<Var, X, En2>, Y>>>, Chc<En1,Ty>>, Chc<Chc<Triple<Var, X, En2>, Y>, Pair<Integer, Att1>>>> sks; 
	...
	@Override
	public BiFunction<Gen, En2, Term<Void, En2, Void, Fk2, Void, Row<En2, Chc<Integer, Term<Ty, En1, Sym, Fk1, Att1, Triple<Var, X, En2>, Chc<Triple<Var, X, En2>, Y>>>, Chc<En1,Ty>>, Void>> gens() {
		return gens;
	}

	@Override
	public BiFunction<Sk, Ty, Term<Ty, En2, Sym, Fk2, Att2, Row<En2, Chc<Integer, Term<Ty, En1, Sym, Fk1, Att1, Triple<Var, X, En2>, Chc<Triple<Var, X, En2>, Y>>>, Chc<En1,Ty>>, Chc<Chc<Triple<Var, X, En2>, Y>, Pair<Integer, Att1>>>> sks() {
		return sks;
	}
	...
	@Override
	public Instance<Ty, En2, Sym, Fk2, Att2, Row<En2, Chc<Integer, Term<Ty, En1, Sym, Fk1, Att1, Triple<Var, X, En2>, Chc<Triple<Var, X, En2>, Y>>>, Chc<En1,Ty>>, Chc<Chc<Triple<Var, X, En2>, Y>, Pair<Integer, Att1>>, Row<En2, Chc<Integer, Term<Ty, En1, Sym, Fk1, Att1, Triple<Var, X, En2>, Chc<Triple<Var, X, En2>, Y>>>, Chc<En1,Ty>>, Chc<Chc<Triple<Var, X, En2>, Y>, Pair<Integer, Att1>>> dst() {
		return K;
	}
