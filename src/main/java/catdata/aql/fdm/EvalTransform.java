...
extends Transform<Ty, En2, Sym, Fk2, Att2, Row<En2,Chc<X1,Term<Ty,En1,Sym,Fk1,Att1,Gen1,Sk1>>>, Y1, Row<En2,Chc<X2,Term<Ty,En1,Sym,Fk1,Att1,Gen2,Sk2>>>, Y2, Row<En2,Chc<X1,Term<Ty,En1,Sym,Fk1,Att1,Gen1,Sk1>>>, Y1, Row<En2,Chc<X2,Term<Ty,En1,Sym,Fk1,Att1,Gen2,Sk2>>>, Y2>  {
	...
	public EvalTransform(Query<Ty, En1, Sym, Fk1, Att1, En2, Fk2, Att2> q, Transform<Ty, En1, Sym, Fk1, Att1, Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> h, AqlOptions options) {
		...
		for (Entry<Row<En2, Chc<X1, Term<Ty, En1, Sym, Fk1, Att1, Gen1, Sk1>>>, En2> gen1 : src.gens().entrySet()) {
			BiFunction<Chc<X1, Term<Ty, En1, Sym, Fk1, Att1, Gen1, Sk1>>,Object,Chc<X2, Term<Ty, En1, Sym, Fk1, Att1, Gen2, Sk2>>>
			fn = (z, t) -> z.left ? Chc.inLeft(h.repr(((Chc<Ty,En1>)t).r,z.l)) : Chc.inRight(h.trans(z.r));
			Row<En2,Chc<X2,Term<Ty,En1,Sym,Fk1,Att1,Gen2,Sk2>>> 
			r = gen1.getKey().map(fn);
			Term<Void,En2,Void,Fk2,Void,Row<En2,Chc<X2,Term<Ty,En1,Sym,Fk1,Att1,Gen2,Sk2>>>,Void>
			t = Term.Gen(r);
