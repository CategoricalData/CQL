...
public abstract class MorExp extends Exp<Mor<Ty, Sym, Ty, Sym>> {
	...
	@Override
	public Exp<Mor<Ty, Sym, Ty, Sym>> Var(String v) {
	...
	public static final class MorExpVar extends MorExp {
		...
		@Override
		public Mor<Ty, Sym, Ty, Sym> eval0(AqlEnv env,
				boolean isC) {
			return (Mor<Ty, Sym, Ty, Sym>) env.defs.tms.get(var);
		}
		...
		public Pair<TyExp, TyExp> type(AqlTyping G) {
			...
			return (Pair<TyExp, TyExp>) ((Object) G.defs.tms.get(var));
		}
