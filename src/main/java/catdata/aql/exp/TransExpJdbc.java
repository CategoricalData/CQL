...
extends TransExpImport<Gen, Sk, Gen, Sk, X1, Y1, X2, Y2, Connection>  {
	...
	public TransExpJdbc(String clazz, String jdbcString, InstExp<Gen, Sk, X1, Y1> src, InstExp<Gen, Sk, X2, Y2> dst, List<Pair<LocStr, String>> map, List<Pair<String, String>> options) {
