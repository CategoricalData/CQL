...
public final class InstExpDiff<Gen, Sk, X, Y, X1, Gen1, Sk1> extends InstExp<X, Y, X, Y> {
  ...
  @Override
  public synchronized Instance<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, X, Y, X, Y> eval0(
      AqlEnv env, boolean isC) {
    Instance<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, Gen, Sk, X, Y> a = I
        .eval(env, isC);
    Instance<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, Gen1, Sk1, X1, Y> b = J
        .eval(env, isC);
