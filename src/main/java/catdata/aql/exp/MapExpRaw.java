...
public final class MapExpRaw extends MapExp implements Raw {
  ...
  public Mapping<String, String, Sym, Fk, Att, String, Fk, Att> eval0(AqlEnv env, boolean isC) {
    ...
    Map<Att, Triple<String, String, Term<String, String, Sym, Fk, Att, Void, Void>>> atts0 = new LinkedHashMap<>(atts.size());
    ...
    Util.putAllSafely(ens0, Util.toMapSafely(
        ens.stream().map(x -> new Pair<>((x.first), (x.second))).collect(Collectors.toList())));
    ...
    for (Pair<Pair<String, String>, Triple<String, String, RawTerm>> att : atts) {
      try {
        ...
        Term<String, String, Sym, Fk, Att, String, String> term0 = RawTerm.infer1x(ctx, term, null, proposed_ty2,
