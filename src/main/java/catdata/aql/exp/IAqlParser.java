...
public interface IAqlParser {
	...
	public static final String[] res = new String[] { "cascade_delete", "fromCoSpan", "dom_q", "cod_q", "dom_t", "cod_t", "except_return",
			"quotient_query", "pivot", "include", "except", "check_query", "distinct_return",
			...
			"command", "graph", "exec_jdbc", "exec_js", "exec_cmdline", "literal", 
			"identity", "match", "attributes", "empty", "imports", "types", "constants", "functions", "equations",
			"forall", "java_types", "multi_equations", "pi", "bindings", "fromSchema",
			"toQuery", "toCoQuery", "anonymize", "frozen",  "params", 
			"java_constants", "java_functions", "options", "entities", "dom_m", "unique", "cod_m", "path_equations",
