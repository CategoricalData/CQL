...
public interface IAqlParser {
	...
	public static final String[] res = new String[] { "to_prefix", "from_prefix", "prefix", "ms_query", "import_jdbc_direct", "ms_catalog", "spanify_mapping", "export_rdf_direct_xml", "import_md", "import_xml_all", "import_json_ld_all", "export_json_instance", "export_rdf_instance_xml", "check_sql", "aggregate", "case", "from", "base", "label", "fst", "snd", "inl", "inr", "equalize_u", "equalize",
			...
			"constants", "functions", "equations", "forall", "java_types", "external_types", "multi_equations", "pi", "bindings",
			"fromSchema", "toQuery", "toCoQuery", "anonymize", "frozen", "params", "java_constants", "java_functions", "external_parsers", "external_functions",
			...
			"import_jdbc", "import_rdf_all", "import_jdbc_all", "export_jdbc_transform", "export_jdbc_instance", "export_jdbc_query",
