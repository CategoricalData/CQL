...
public class TransExpCoEval<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> extends
    TransExp<Triple<String, X1, String>, Chc<Triple<String, X1, String>, Y1>, Triple<String, X2, String>, Chc<Triple<String, X2, String>, Y2>, Integer, Chc<Chc<Triple<String, X1, String>, Y1>, Pair<Integer, Att>>, Integer, Chc<Chc<Triple<String, X2, String>, Y2>, Pair<Integer, Att>>> {
  ...
  @Override
  public Pair<InstExp<Triple<String, X1, String>, Chc<Triple<String, X1, String>, Y1>, Integer, Chc<Chc<Triple<String, X1, String>, Y1>, Pair<Integer, Att>>>, InstExp<Triple<String, X2, String>, Chc<Triple<String, X2, String>, Y2>, Integer, Chc<Chc<Triple<String, X2, String>, Y2>, Pair<Integer, Att>>>> type(
      AqlTyping G) {
  ...
  @Override
  public Transform<String, String, Sym, Fk, Att, Triple<String, X1, String>, Chc<Triple<String, X1, String>, Y1>, Triple<String, X2, String>, Chc<Triple<String, X2, String>, Y2>, Integer, Chc<Chc<Triple<String, X1, String>, Y1>, Pair<Integer, Att>>, Integer, Chc<Chc<Triple<String, X2, String>, Y2>, Pair<Integer, Att>>> eval0(
