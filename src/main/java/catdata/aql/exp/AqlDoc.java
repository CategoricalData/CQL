...
public final class AqlDoc implements SemanticsVisitor<String, Unit, RuntimeException> {
	...
	@Override
	public <Ty, En, Sym, Fk, Att, Gen, Sk, X, Y> String visit(String k, Unit arg, Instance<Ty, En, Sym, Fk, Att, Gen, Sk, X, Y> I)  {
		return "\n" + AqlInACan.toHtml(env, (Instance<catdata.aql.exp.Ty, catdata.aql.exp.En, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, catdata.aql.exp.Gen, catdata.aql.exp.Sk, X, Y>) I);
	}

	@Override
	public <Ty, En, Sym, Fk, Att, Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> String visit(String k, Unit arg, Transform<Ty, En, Sym, Fk, Att, Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> h)  {
		return "";
	}
	...
	@Override
	public <Ty, En1, Sym, Fk1, Att1, En2, Fk2, Att2> String visit(String k, Unit arg, Query<Ty, En1, Sym, Fk1, Att1, En2, Fk2, Att2> Q)  {
		return ""; 
	}

	@Override
	public <Ty, En1, Sym, Fk1, Att1, En2, Fk2, Att2> String visit(String k, Unit arg, Mapping<Ty, En1, Sym, Fk1, Att1, En2, Fk2, Att2> M)  {
		return "";
	}
