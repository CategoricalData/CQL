...
public final class InstExpChase<Gen, Sk, X, Y> extends InstExp<Object, Object, Object, Object> {
  ...
  @Override
  public synchronized Instance<String, String, Sym, Fk, Att, Object, Object, Object, Object> eval0(AqlEnv env, boolean isC) {
    if (isC) {
      // eds.eval(env, true);
      // I.eval(env, true);
    ...
    Instance<String, String, Sym, Fk, Att, ?, ?, ?, ?> ret = eds.eval(env, false)
        .chase((Instance<String, String, Sym, Fk, Att, Gen, Sk, Integer, Y>) I.eval(env, false), ops);
