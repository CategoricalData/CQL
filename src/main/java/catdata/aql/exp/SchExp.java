...
public abstract class SchExp extends Exp<Schema<Ty,En,Sym,Fk,Att>> {	
	...
	public static interface SchExpCoVisitor<R, P, E extends Exception> {
		...
		public abstract <N> SchExpColim<N> visitSchExpColim(P params, R exp) throws E;
	...
	public abstract <R,P,E extends Exception> SchExp
		coaccept(P params, SchExpCoVisitor<R,P,E> v, R r) throws E;
	...
	public static interface SchExpVisitor<R,P,E extends Exception> {
		...
		public abstract <N> R visit(P params, SchExpColim<N> exp) throws E;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static final class SchExpPivot<Gen,Sk,X,Y> extends SchExp {
		...
		@Override
		public SchExp resolve(AqlTyping G,
				Program<Exp<?>> prog) {
			return this;
		}
