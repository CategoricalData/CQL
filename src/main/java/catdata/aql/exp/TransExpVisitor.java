...
public interface TransExpVisitor<R, P, E extends Exception> {
	public  <Gen1, Sk1,  Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpCoEval<Gen1, Sk1,  Gen2, Sk2, X1, Y1, X2, Y2> exp) throws E; 
	...
	public  <Gen1, Sk1,  Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpDelta<Gen1, Sk1,  Gen2, Sk2, X1, Y1, X2, Y2> exp) throws E; 
	public  < Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpDistinct< Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp) throws E;
	public  <Gen1, Sk1,  Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpEval<Gen1, Sk1,  Gen2, Sk2, X1, Y1, X2, Y2> exp) throws E;
	public  < Gen, Sk, X, Y> R visit(P params, TransExpId< Gen, Sk, X, Y> exp) throws E; 
	public  < Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpLit< Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp) throws E;
	public  <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpSigma<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp) throws E; 
	...
	public  <Gen1,Sk1,Gen2,Sk2,X1,Y1,X2,Y2,Gen3,Sk3,X3,Y3> R visit(P params, TransExpCompose<Gen1,Sk1,Gen2,Sk2,X1,Y1,X2,Y2,Gen3,Sk3,X3,Y3> exp) throws E;
