  ...
  public synchronized Query<String, String, Sym, Fk, Att, String, Fk, Att> eval0(AqlEnv env, boolean isC) {
    ...
    for (QueryExp k : imports) {
      ...
      for (Fk Fk : v.fks.keySet()) {
        Transform<String, String, Sym, catdata.aql.exp.Fk, Att, String, String, String, String, ID, Chc<String, Pair<ID, Att>>, ID, Chc<String, Pair<ID, Att>>> w = v.fks.get(Fk);
      ...
      for (Pair<catdata.aql.exp.Fk, Trans> pp : p.fks) {
        try {
          ...
          //      ens0.get(qqq.first).first);
            //Map<String, Chc<Ty, String>> Map1 = Util.map(Map, (k, x) -> new Pair<>(k, x.reverse()));
            Collage<String, String, Sym, Fk, Att, String, String> col = cols.get(dst0.fks.get(pp.first).first);
            Chc<String, String> required = ens0
                .get(dst0.fks.get(pp.first).second).first.get(v.first);
            if (required == null) {
              throw new RuntimeException("Not an entity or type: " + v.first);
            }
            Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String> term = RawTerm
                .infer1x(Collections.emptyMap() /*Not Map1*/, v.second, null, required.reverse(), col.convert(),
                    "in foreign key " + pp.first.str + ", ", src0.typeSide.js).second;
            Term<String, String, Sym, Fk, Att, String, String> l = term.convert();
            Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String> r = Query
                .freeze(l, params, set);
...
//          System.out.println("++++++++" + doNotCheckEqs);
  ...
  public static synchronized void processAtt(Schema<String, String, Sym, Fk, Att> src0, Schema<String, String, Sym, Fk, Att> dst0,
    ...
    if (pp.second.left) {
      Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String> term = RawTerm
          .infer1x(Collections.emptyMap() /* not ens! */, pp.second.l, null, required, col.convert(), "", src0.typeSide.js).second;
      ...
      Term<String, String, Sym, Fk, Att, String, String>
      zeroX = RawTerm.infer1x(ens1x, pre.zero, null, required, col.convert(), "", src0.typeSide.js).second;
      Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>
    ...
    //  Map<String, Chc<Ty,String>> u = new THashMap<>(ens1);
      ...
      Term<String, String, Sym, Fk, Att, String, String>
      retX   = RawTerm.infer1x(Collections.emptyMap() /*not u*/, pre.ret, null, required, col.convert(), "", src0.typeSide.js).second;
      Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>
      ret    = Query.freeze(retX.convert(), params, set);

      Set<Pair<Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>, Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>>>
      lwhere = new THashSet<>();
      ...
      for (Pair<RawTerm, RawTerm> eq : pre.leqs) {
        ...
        Triple<Map<String, Chc<String, String>>, Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>, Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>> x = RawTerm
            .infer1x(Collections.emptyMap() /* not u */, eq.first, eq.second, null,
      ...
      Agg<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att> agg = new Agg<>(zero, op, lfrom, lwhere, ret, ctx);
  ...
  public static synchronized void processBlock(Map<String, String> options, AqlEnv env,
    ...
    for (Pair<RawTerm, RawTerm> eq : p.eqs) {
      Triple<Map<String, Chc<String, String>>, Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>, Term<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>> x = RawTerm
          .infer1x(Collections.emptyMap() /* not Map! */, eq.first, eq.second, null,
              col.convert(), "In equation " + eq.first + " = " + eq.second + ", ", src0.typeSide.js)
          .first3();
