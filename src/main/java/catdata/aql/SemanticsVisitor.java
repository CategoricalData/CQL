...
public interface SemanticsVisitor<R,G,E extends Throwable> {
	...
	public <Ty, En, Sym, Fk, Att, Gen, Sk, X, Y> R visit(String k, G arg, Instance<Ty, En, Sym, Fk, Att, Gen, Sk, X, Y> I) throws E;

	public <Ty,En,Sym,Fk,Att,Gen1,Sk1,Gen2,Sk2,X1,Y1,X2,Y2> R visit(String k, G arg, Transform<Ty,En,Sym,Fk,Att,Gen1,Sk1,Gen2,Sk2,X1,Y1,X2,Y2> h) throws E;

	public R visit(String k, G arg, Pragma P) throws E;
	
	public R visit(String k, G arg, Comment C) throws E;
	
	public <Ty,En1,Sym,Fk1,Att1,En2,Fk2,Att2> R visit(String k, G arg, Query<Ty,En1,Sym,Fk1,Att1,En2,Fk2,Att2> Q) throws E;
	
	public <Ty,En1,Sym,Fk1,Att1,En2,Fk2,Att2> R visit(String k, G arg, Mapping<Ty,En1,Sym,Fk1,Att1,En2,Fk2,Att2> M) throws E;
