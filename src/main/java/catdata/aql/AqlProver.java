  ...
  private AqlProver(AqlOptions ops, Collage<Ty, En, Sym, Fk, Att, Gen, Sk> col, AqlJs<Ty, Sym> js, boolean doTrivialityCheck) {
    ...
    switch (name) {
      ...
      case completion:
        ...
        if (str != null) {
          ...
          Collage<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String> col2 = (Collage<String, String, catdata.aql.exp.Sym, catdata.aql.exp.Fk, catdata.aql.exp.Att, String, String>) col;
          for (String x : z) {
            try {
        ...
        break;
      case monoidal:
        dpkb = new catdata.aql.MonoidalFreeDP<>(col_simpl.toKB());
        break;
      case e:
    ...
    if (doTrivialityCheck &&
      ...
      try {
        ...
        KBExp<Head<Ty, En, Sym, Fk, Att, Gen, Sk>, String> l = dpkb.kb.factory.KBVar(x), r = dpkb.kb.factory.KBVar(y);
