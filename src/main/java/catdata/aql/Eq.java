...
public class Eq<Ty, En, Sym, Fk, Att, Gen, Sk> {
  ...
  public final Map<String, Chc<Ty, En>> ctx;
  private int code;

  public Eq(Map<String, Chc<Ty, En>> ctx, Term<Ty, En, Sym, Fk, Att, Gen, Sk> lhs,
  ...
  public final Triple<Map<String, Chc<Ty, En>>, Term<Ty, En, Sym, Fk, Att, Gen, Sk>, Term<Ty, En, Sym, Fk, Att, Gen, Sk>> toTriple() {
