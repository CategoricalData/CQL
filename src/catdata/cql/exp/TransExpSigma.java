...
import catdata.cql.fdm.SigmaTransform;
...
public final class TransExpSigma<Gen1, Gen2, Sk1, Sk2, X1, Y1, X2, Y2> extends
  ...
  @Override
  public synchronized Transform<String, String, Sym, Fk, Att, Gen1, Sk1, Gen2, Sk2, Integer, Chc<Sk1, Pair<Integer, Att>>, Integer, Chc<Sk2, Pair<Integer, Att>>> eval0(
