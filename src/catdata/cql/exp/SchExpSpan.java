...
public class SchExpSpan extends SchExp {
  ...
  protected Schema<String, String, Sym, Fk, Att> eval0(AqlEnv env, boolean isCompileTime) {
    ...
    Map<String, Triple<Map<String, Chc<String, String>>, Collection<Eq<String, String, Sym, Fk, Att, String, String>>, AqlOptions>> ens = Util.mk();
    Map<Att, Chc<Term<String, String, Sym, Fk, Att, String, String>, Agg<String, String, Sym, Fk, Att>>> atts = Util.mk();
    Map<Fk, Pair<Map<String, Term<Void, String, Void, Fk, Void, String, Void>>, AqlOptions>> fks = Util.mk();
    Map<Fk, Map<String, Term<String, String, Sym, Fk, Att, String, String>>> fks2 = Util.mk();
    ...
    for (Entry<Fk, Pair<String, String>> fk : relOlog.fks.entrySet()) {
      ...
      Map<String, Chc<String, String>> ctx = Util.mk();
