...
public class TransExpJdbc<X1, Y1, X2, Y2> extends TransExpImport<String, String, String, String, X1, Y1, X2, Y2, Connection> {
  ...
  public TransExpJdbc(/*String clazz,*/ String jdbcString, InstExp<String, String, X1, Y1> src, InstExp<String, String, X2, Y2> dst,
  ...
  @Override
  protected void processEn(String en, Schema<String, String, Sym, Fk, Att> sch, Connection conn, String q) throws Exception {
