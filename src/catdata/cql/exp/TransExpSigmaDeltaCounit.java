...
import catdata.cql.fdm.SigmaDeltaCounitTransform;

public class TransExpSigmaDeltaCounit<Gen, Sk, X, Y>
    extends TransExp<Pair<String, X>, Y, Gen, Sk, Integer, Chc<Y, Pair<Integer, Att>>, X, Y> {
  ...
  @Override
  public synchronized Transform<String, String, Sym, Fk, Att, Pair<String, X>, Y, Gen, Sk, Integer, Chc<Y, Pair<Integer, Att>>, X, Y> eval0(
  ...
  @Override
  public Pair<InstExp<Pair<String, X>, Y, Integer, Chc<Y, Pair<Integer, Att>>>, InstExp<Gen, Sk, X, Y>> type(
      AqlTyping G) {
    SchExp x = I.type(G);
