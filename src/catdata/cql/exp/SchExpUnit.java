...
public final class SchExpUnit extends SchExp {

  public final TyExp typeSide;

  public SchExp resolve(AqlTyping G, Program<Exp<?>> prog) {
    return new SchExpUnit(typeSide.resolve(prog));
  }
  ...
  public SchExpUnit(TyExp typeSide) {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    SchExpUnit other = (SchExpUnit) obj;
  ...
  public Schema<String, String, Sym, Fk, Att> eval0(AqlEnv env, boolean isC) {
    return Schema.unit(typeSide.eval(env, isC));
  }
