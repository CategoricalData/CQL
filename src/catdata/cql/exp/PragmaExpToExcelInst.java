...
import catdata.cql.fdm.ToExcelPragmaInstance;

@SuppressWarnings("hiding")
public final class PragmaExpToExcelInst<X, Y> extends PragmaExp {
...
//		set.add(AqlOption.prepend_entity_on_ids);
	...
	public PragmaExpToExcelInst(InstExp<String, String, X, Y> inst, String file, List<Pair<String, String>> options) {
	...
	public Pragma eval0(AqlEnv env, boolean isC) {
		...
		return new ToExcelPragmaInstance<>(inst.eval(env, false), file, op);
	}

	@Override
	public String toString() {
		final StringBuilder sb = new StringBuilder().append("export_excel_instance ").append(inst).append(" ")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PragmaExpToExcelInst<?, ?> other = (PragmaExpToExcelInst<?, ?>) obj;
		if (file == null) {
			if (other.file != null)
				return false;
