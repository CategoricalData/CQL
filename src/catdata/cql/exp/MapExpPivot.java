...
public final class MapExpPivot<Gen, Sk, X, Y> extends MapExp {
  ...
  @Override
  public Mapping<String, String, Sym, Fk, catdata.cql.exp.Att, String, Fk, Att> eval0(AqlEnv env, boolean isC) {
    AqlOptions strat = new AqlOptions(ops, env.defaults);
    Mapping<String, String, Sym, catdata.cql.exp.Fk, catdata.cql.exp.Att, String, Fk, Att> l = new CqlPivot<>(
