...
public abstract class MapExp extends Exp<Mapping<String, String, Sym, Fk, Att, String, Fk, Att>> {
  ...
  @Override
  public Exp<Mapping<String, String, Sym, Fk, Att, String, Fk, Att>> Var(String v) {
  ...
  public static interface MapExpCoVisitor<R, P, E extends Exception> {
    ...
    public MapExpPseudo visitMapExpPseudo(P params, R exp) throws E;
  ...
  public static interface MapExpVisitor<R, P, E extends Exception> {
	...
	public R visit(P params, MapExpPseudo exp) throws E;
  }
  ...
  public static final class MapExpVar extends MapExp {
    ...
    @Override
    public Mapping<String, String, catdata.cql.exp.Sym, Fk, Att, String, Fk, Att> eval0(AqlEnv env, boolean isC) {
...
/////////////////////////////////////////////////////////////////////
  ...
  public static final class MapExpLit extends MapExp {
    ...
    public final Mapping<String, String, Sym, Fk, Att, String, Fk, Att> map;

    public MapExpLit(Mapping<String, String, Sym, Fk, Att, String, Fk, Att> map) {
      this.map = map;
    }
